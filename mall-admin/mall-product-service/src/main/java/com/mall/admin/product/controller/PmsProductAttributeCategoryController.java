 ...
 */
@RestController
@Api(value = "PmsProductAttributeCategoryController", tags = "product-商品属性分类管理")
...
public class PmsProductAttributeCategoryController {
    ...
    @ResponseBody
    public CommonResult<List<PmsProductAttributeCategoryItemVO>> getListWithAttr() {
        List<PmsProductAttributeCategoryItemVO> productAttributeCategoryResultList = productAttributeCategoryService.getListWithAttr();
