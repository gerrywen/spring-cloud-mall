...
import com.mall.admin.product.dao.*;
...
//    private CmsPrefrenceAreaProductRelationDao prefrenceAreaProductRelationDao;
    ...
    @Override
    public int create(PmsProductDTO productParam) {
        int count;
        //创建商品
...
//        relateAndInsertList(prefrenceAreaProductRelationDao, productParam.getPrefrenceAreaProductRelationList(), productId);
    ...
    @Override
    public PmsProductVO getUpdateInfo(Long id) {
        return productDao.getUpdateInfo(id);
    }

    @Override
    public int update(Long id, PmsProductDTO productParam) {
        int count;
        //更新商品信息
        PmsProduct product = productParam;
        product.setId(id);
...
//        relateAndInsertList(prefrenceAreaProductRelationDao, productParam.getPrefrenceAreaProductRelationList(), id);
    ...
    @Override
    public List<PmsProduct> list(PmsProductQueryDTO productQueryParam, Integer pageSize, Integer pageNum) {
     ...
     * @deprecated 旧版创建
     */
    public int createOld(PmsProductDTO productParam) {
        int count;
        //创建商品
        PmsProduct product = productParam;
        product.setId(null);
