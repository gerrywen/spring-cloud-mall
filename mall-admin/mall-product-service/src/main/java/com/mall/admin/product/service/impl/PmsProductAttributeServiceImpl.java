...
import com.mall.admin.mapper.PmsProductAttributeCategoryMapper;
import com.mall.admin.mapper.PmsProductAttributeMapper;
import com.mall.admin.model.PmsProductAttribute;
import com.mall.admin.model.PmsProductAttributeCategory;
import com.mall.admin.model.PmsProductAttributeExample;
import com.mall.admin.product.dao.PmsProductAttributeDao;
...
public class PmsProductAttributeServiceImpl implements PmsProductAttributeService {
    ...
    @Override
    public int create(PmsProductAttributeDTO pmsProductAttributeParam) {
    ...
    @Override
    public int update(Long id, PmsProductAttributeDTO productAttributeParam) {
        PmsProductAttribute pmsProductAttribute = new PmsProductAttribute();
    ...
    @Override
    public List<PmsProductAttrInfoVO> getProductAttrInfo(Long productCategoryId) {
