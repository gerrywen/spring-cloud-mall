 ...
 */
@RestController
@Api(value = "SmsFlashPromotionSessionController", tags = "marketing-限时购场次管理")
...
public class SmsFlashPromotionSessionController {
    ...
    @ResponseBody
    public CommonResult<List<SmsFlashPromotionSessionDetailVO>> selectList(Long flashPromotionId) {
        List<SmsFlashPromotionSessionDetailVO> promotionSessionList = flashPromotionSessionService.selectList(flashPromotionId);
        return CommonResult.success(promotionSessionList);
    }
}