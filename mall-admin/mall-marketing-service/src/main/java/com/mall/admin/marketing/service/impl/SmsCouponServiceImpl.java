...
import com.mall.admin.mapper.SmsCouponProductCategoryRelationMapper;
import com.mall.admin.mapper.SmsCouponProductRelationMapper;
import com.mall.admin.marketing.dao.SmsCouponDao;
import com.mall.admin.marketing.dao.SmsCouponProductCategoryRelationDao;
import com.mall.admin.marketing.dao.SmsCouponProductRelationDao;
...
public class SmsCouponServiceImpl implements SmsCouponService {
    ...
    @Override
    public int create(SmsCouponDTO couponParam) {
    ...
    @Override
    public int update(Long id, SmsCouponDTO couponParam) {
    ...
    @Override
    public SmsCouponVO getItem(Long id) {
