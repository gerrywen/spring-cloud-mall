package com.xinya.item.web;

import com.xinya.item.po.Category;
import com.xinya.item.service.CategoryService;
...
public class CategoryController {
    ...
    @GetMapping("/list/{pid}")
    public ResponseEntity<List<Category>> queryCategoryByPid(@RequestParam(value = "pid", defaultValue = "-1") Long pid) {
     ...
     */
    @GetMapping("bid/{bid}")
    public ResponseEntity<List<Category>> queryByBrandId(@RequestParam(value = "bid") Long bid) {
     ...
     */
    @GetMapping("names")
    public ResponseEntity<List<String>> queryNameByIds(@RequestParam(value = "ids") List<Long> ids) {
