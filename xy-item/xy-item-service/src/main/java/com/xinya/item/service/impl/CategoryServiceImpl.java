package com.xinya.item.service.impl;

import com.xinya.item.mapper.CategoryMapper;
import com.xinya.item.po.Category;
import com.xinya.item.service.CategoryService;
import com.xinya.myexception.MyException;
import com.xinya.myexception.XyException;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    public List<Category> queryCategoryByPid(Long pid) throws MyException {
        ...
        if (CollectionUtils.isEmpty(list)) {
            throw new MyException(XyException.CATEGORY_NOT_FOUND);
        }
        return list;
    }
